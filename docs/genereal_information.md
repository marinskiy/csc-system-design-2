...
* Удобство использования. Система должна быть спроектирована таким образом, чтобы игроки, незнакомые с игрой, быстро и интуитивно могли её освоить. Для этого следует где это возможно использовать комнанды, общеприняты для игр этого жанра, а также подсказки.
